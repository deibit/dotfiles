...
map("n", "<leader>x", "<cmd>lua MiniBufremove.delete()<CR>", default_opts)
...
-- DiffView
map("n", "<leader>d", "<cmd>DiffviewOpen<CR>", default_opts)
map("n", "<leader>D", "<cmd>DiffviewClose<CR>", default_opts)
